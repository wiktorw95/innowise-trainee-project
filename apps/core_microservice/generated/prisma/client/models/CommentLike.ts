...
export type CommentLikeWhereInput = {
  ...
  profileId?: Prisma.StringFilter<"CommentLike"> | string
...
export type CommentLikeWhereUniqueInput = Prisma.AtLeast<{
  profileId_commentId?: Prisma.CommentLikeProfileIdCommentIdCompoundUniqueInput
  AND?: Prisma.CommentLikeWhereInput | Prisma.CommentLikeWhereInput[]
  OR?: Prisma.CommentLikeWhereInput[]
  NOT?: Prisma.CommentLikeWhereInput | Prisma.CommentLikeWhereInput[]
  profileId?: Prisma.StringFilter<"CommentLike"> | string
...
export type CommentLikeScalarWhereWithAggregatesInput = {
  ...
  profileId?: Prisma.StringWithAggregatesFilter<"CommentLike"> | string
...
export type CommentLikeCreateInput = {
  ...
  profile: Prisma.ProfileCreateNestedOneWithoutCommentLikesInput
...
export type CommentLikeUpdateInput = {
  ...
  profile?: Prisma.ProfileUpdateOneRequiredWithoutCommentLikesNestedInput
...
export type CommentLikeProfileIdCommentIdCompoundUniqueInput = {
  profileId: string
  commentId: string
}
...
export type CommentLikeOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"profileId" | "commentId" | "createdAt", ExtArgs["result"]["commentLike"]>
...
export interface CommentLikeDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const commentLikeWithProfileIdOnly = await prisma.commentLike.findMany({ select: { profileId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many CommentLikes and only return the `profileId`
   * const commentLikeWithProfileIdOnly = await prisma.commentLike.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more CommentLikes and only return the `profileId`
   * const commentLikeWithProfileIdOnly = await prisma.commentLike.updateManyAndReturn({
   *   select: { profileId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface CommentLikeFieldRefs {
  readonly profileId: Prisma.FieldRef<"CommentLike", 'String'>
